...
import com.myowin.eastypeasy.view.adapter.restaurant_detail.DishesAdapter

class MainDishesFragment : Fragment(R.layout.fragment_main_dishes){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvMenu.adapter = DishesAdapter(testDishes)
    }
}